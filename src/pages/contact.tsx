            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-8 h-full">
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-slate-600 dark:text-slate-300">
                          <a href="mailto:support@brandforge.pro" className="hover:text-blue-600 dark:hover:text-blue-400">
                            support@brandforge.pro
                          </a>
                        </p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-slate-600 dark:text-slate-300">
                          <a href="tel:+1-555-123-4567" className="hover:text-purple-600 dark:hover:text-purple-400">
                            +1 (555) 123-4567
                          </a>
                        </p>
                        <p className="mt-1 text-slate-500 dark:text-slate-400 text-sm">
                  ...
                  <div className="mt-12">
                    <h3 className="text-lg font-medium text-slate-900 dark:text-white mb-4">Follow us</h3>
